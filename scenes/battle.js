function setBattle(worldState) {
    ...
    const content = box.add([
        text('ULOK is ready to battle!', { size: 42}),
        color(10,10,10),
        pos(20,20)
    ])
    ...
    onKeyPress('space', () => {
        ...
        if (phase === 'player-turn') {
            ...
            if (damageDealt > 150) {
                ...
                content.text = 'ULOK used kick ass assault.'
            }
    ...
    onUpdate(() => {
        ...
        if (enemyMonHealthBar.width < 0 && !enemyMon.fainted) {
            ...
            setTimeout(() => {
                content.text = 'ULOK won the battle!'
            }, 1000)
            setTimeout(() => {
        ...
        if (playerMonHealthBar.width < 0 && !playerMon.fainted) {
            ...
            content.text = 'ULOK fainted!'
            playerMon.fainted = true
            setTimeout(() => {
                content.text = 'You rush to get ULOK healed!'
            }, 1000)
            setTimeout(() => {
