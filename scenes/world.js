function setWorld(worldState) {
    ...
    add([sprite('mini-mons'), area(), body({isStatic: true}), pos(100,700), scale(4), 'ering'])

    const damangMon = add([sprite('mini-mons'), area(), body({isStatic: true}), pos(400,300), scale(4), 'damang'])
    damangMon.play('damang')
    damangMon.flipX = true

    const ulihipanMon = add([sprite('mini-mons'), area(), body({isStatic: true}), pos(100,100), scale(4), 'ulihipan'])
    ulihipanMon.play('ulihipan')

    const sagbotMon = add([sprite('mini-mons'), area(), body({isStatic: true}), pos(900, 570), scale(4), 'sagbot'])
    sagbotMon.play('sagbot')
    ...
    player.onCollide('npc', () => {
        ...
        const dialogue = "Defeat all Balbal on this island and you'll become the champion!"
        ...
        if (worldState.faintedMons < 4) {
            ...
            content.text = "Yohoo! You're the champion!"
        }
    ...
    onCollideWithPlayer('ering', player, worldState)
    onCollideWithPlayer('damang', player, worldState)
    onCollideWithPlayer('ulihipan', player, worldState)
    onCollideWithPlayer('sagbot', player, worldState)
}